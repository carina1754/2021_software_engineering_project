...
<html lang="en">
	...
	<div class="container-fluid">
		<div class="row" align="center">
			<div class="col-md-4">
				<div class="caption">
					<a href="Burger_Rank.jsp"><h3>종합 순위</h3></a>
				</div>
			</div>
	...
	<div class="container-fluid">
		<div class="row" align="center">
			<div class="col-md-4">
				<div class="caption">
					<a href="Burger_Rank.jsp?name=<%=user_id%>&state=<%=user_state%>"><h3>종합 순위</h3></a>
				</div>
			</div>
	...
	<%}%>            
            ...
            <%
            	...
            	if (user_state.compareTo("2") == 0){
            		%>
	            		<div align="right">
	            			<button type="button" class="btn btn-primary btn-lg" id="save" onclick="location.href='Brand_Burger_Manage.jsp?name=<%= user_id %>&state=<%= user_state %>'">메뉴 관리</button>
	            		</div>
