				  ...
				  <tbody>
				    ...
				    %>
                      <tr>
                        ...
                        <td><input type="button" value="삭제 하기" onclick="location.href='mypage_action.jsp?name=<%=reviews.get(i).get_review_id()%>'"></td>
                        </tr>
                     <%} %>
				  </tbody>
				</table>
				  ...
				  <tbody>
				    ...
				    %>
                      <tr>
                        ...
                        <td><input type="button" value="구독 취소" onclick="location.href='mypage_sub_action.jsp?name=<%=subscribes.get(i).getsubscribe_id()%>'"></td>
                        </tr>
                     <%} %>
				  </tbody>
			  </table>
