...
<body class="container">
	...
	<!--브랜드 순위-->
            <div class="container">
                ...
                <%if(uname == null && state == null){ %>
                <a href="Brand_Rank.jsp"><p class="text-right">전체 순위 보기</p></a>
				<%}else{ %>
				<a href="Brand_Rank.jsp?name=<%=uname%>&state=<%=state%>"><p class="text-right">전체 순위 보기</p></a>
            	<%} %>
            </div>
	<p style="height:50px"></p>
                       ...
                       <div class="item active">
                          <div class="row-fluid">
                             ...
                             <%for(int i=0; i<brandMenu_1.size(); i++){
                                ...
                                <div class="col-md-3">
                                   <a class="thumbnail">
                                  <img style="height:240px;width:240px;" src="./img/<%=brandMenu_1.get(i).getMenu_id()%>.jfif">
                                   <div class="caption">
                       ...
                       <div class="item active">
                          <div class="row-fluid">
                             ...
                             <%for(int i=0; i<brandMenu_2.size(); i++){
                                ...
                                <div class="col-md-3">
                                   <a class="thumbnail">
                                   <img style="height:240px;width:240px;" src="./img/<%=brandMenu_2.get(i).getMenu_id()%>.jfif">
                                   <div class="caption">
