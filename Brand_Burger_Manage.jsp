            ...
            <table class="table table-hover">
  				...
  				<tbody>
    				<tr class="table-active">
      					...
      					<td>
		     				<select class="form-control form-select-lg mb-3" aria-label="Default select example">
								<option selected>버거킹</option>
								<option value="1">맥도날드</option>
								<option value="2">맘스터치</option>	
								<option value="3">롯데리아</option>								
							</select>
      					</td>
      					<td>
      						<input type="text" class="form-control" placeholder="Burger Name" aria-describedby="basic-addon1" value="불고기 버거">
      					</td>
      					<td>4.8</td>
      					<td>1467</td>
      					<td>
    				...
    				<tr class="table-active">
      					...
      					<td>
      						<input type="text" class="form-control" placeholder="Burger Name" aria-describedby="basic-addon1" value="새우 버거">
      					</td>
      					<td>4.7</td>
      					<td>1320</td>
      					<td>
    				...
    				<tr class="table-active">
      					...
      					<td>
      						<input type="text" class="form-control" placeholder="Burger Name" aria-describedby="basic-addon1" value="데리 버거">
      					</td>
      					<td>4</td>
      					<td>800</td>
      					<td>
